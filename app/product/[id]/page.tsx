...
// ✅ Keep this as a regular function with no types manually declared
export async function generateStaticParams() {
  return [
    { id: 'iphone15' },
    { id: 'samsung22' }
...
// ✅ Do NOT import any `PageProps` from anywhere
/*import Header from '../../components/header';
import Footer from '../../components/footer';
import Image from 'next/image';
import { notFound } from 'next/navigation';
...
// ✅ `generateStaticParams` should not have any types manually added
export async function generateStaticParams() {
  return [
    { id: 'iphone15' },
    { id: 'samsung22' }
...
// ✅ This is the correct type — DO NOT use PageProps or import it
type Props = {
  params: {
    id: string;
  };
...
// ✅ This is perfect — no type required here
export async function generateStaticParams() {
  return [
    { id: 'iphone15' },
    { id: 'samsung22' }
